    ...
    <div className="fixed inset-0 z-50 flex items-start justify-end bg-black/30 p-4 sm:p-6">
      <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl border border-gray-100 overflow-hidden">
        ...
        <div className="p-6">
          ...
          {loading ? (
            <div className="text-sm text-gray-400">Loading settingsâ€¦</div>
          ) : (
        ...
        <form onSubmit={submit} className="flex flex-col gap-3">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button type="submit" disabled={saving} className="flex-1 bg-amber-500 hover:bg-amber-600 text-white font-semibold py-2 rounded-lg text-sm transition disabled:opacity-50">
              {saving ? 'Savingâ€¦' : isEdit ? 'Save Changes' : 'Add Entry'}
            </button>
          </div>
        </form>
      </div>
...
// â”€â”€ Main admin panel â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function AdminPanel({ onLogout }) {
  ...
  const fmt = (col, val) => {
    if (val === null || val === undefined) return <span className="text-gray-300">â€”</span>;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b px-6 py-4 flex items-center justify-between shadow-sm">
        <div>
          <h1 className="text-xl font-bold text-gray-800">Chasdei Mordechai â€” Admin</h1>
      ...
      <div className="max-w-[1440px] mx-auto px-4 py-8">
        ...
        <div className="flex flex-wrap gap-3 items-center mb-6">
          <input
            ...
            placeholder="Search by name, email, phone, addressâ€¦"
        ...
        <p className="text-xs text-gray-400 mb-3">
          {loading ? 'Loadingâ€¦' : `${filtered.length} ${filtered.length === 1 ? 'entry' : 'entries'}${search ? ' (filtered)' : ''}`}
        </p>
        ...
        <div className="bg-white rounded-2xl shadow overflow-x-auto xl:overflow-x-visible">
          {loading ? (
            <div className="flex items-center justify-center py-20 text-gray-400">Loading entriesâ€¦</div>
          ) : filtered.length === 0 ? (
...
// â”€â”€ Page root â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
export default function AdminPage() {
  ...
  if (session === undefined) {
    return <div className="min-h-screen flex items-center justify-center text-gray-400">Loadingâ€¦</div>;
  }
